...
Текущий baseline репозитория — `0.2.16` с target-based plugin contribution
resolution, bundled Markdown/Plain Text renderer chain на Streamdown,
...
реализованы шестнадцать implementation slices, workspace-centered UI follow-up, единый
