...
Текущий baseline репозитория — `0.2.18` с opt-in Dynamic UI from Agents:
bundled Generated React plugin, Core-owned versioned source/build/state/action
...
реализованы восемнадцать implementation slices, workspace-centered UI follow-up, единый
