...
Текущий baseline репозитория — `0.2.15` с production Compose ToolHive runtime,
host Node/Codex, persistent encrypted secrets и bounded private bridge поверх Core-owned Plugin Registry v1,
manifest-driven Web Extension Host и bundled Dark Theme, Agent Tooling,
...
реализованы пятнадцать implementation slices, workspace-centered UI follow-up, единый
