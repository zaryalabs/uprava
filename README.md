...
Текущий baseline репозитория — `0.2.13` с Core-owned Plugin Registry v1,
manifest-driven Web Extension Host и bundled Dark Theme поверх Agent Tooling,
...
реализованы тринадцать implementation slices, workspace-centered UI follow-up, единый
