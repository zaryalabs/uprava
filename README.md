...
Текущий baseline репозитория — `0.2.14` с отдельным Compose ToolHive runtime,
host Node/Codex и bounded private bridge поверх Core-owned Plugin Registry v1,
...
реализованы четырнадцать implementation slices, workspace-centered UI follow-up, единый
