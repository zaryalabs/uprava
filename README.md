...
Текущий baseline репозитория — `0.2.9` с прозрачным live agent timeline и модульными Core/Node runtime
boundaries поверх Causality/Trace UX, запрашиваемого Deduction,
workspace-centered Web UI, Background Jobs и protocol v2.
