...
case "$UPRAVA_CORE_IMAGE:$UPRAVA_WEB_IMAGE:$UPRAVA_GENERATED_UI_BUILDER_IMAGE:$UPRAVA_NODE_ARTIFACT:$UPRAVA_TOOLHIVE_IMAGE:$UPRAVA_TASK_RUNTIME_IMAGE:$UPRAVA_OPENSANDBOX_IMAGE" in
