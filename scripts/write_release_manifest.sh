...
toolhive_state_dir="${UPRAVA_TOOLHIVE_STATE_DIR:?UPRAVA_TOOLHIVE_STATE_DIR is required}"
...
toolhive_config="${UPRAVA_TOOLHIVE_CONFIG:?UPRAVA_TOOLHIVE_CONFIG is required}"
...
toolhive_profile="${UPRAVA_TOOLHIVE_PROFILE:?UPRAVA_TOOLHIVE_PROFILE is required}"
toolhive_version="${UPRAVA_TOOLHIVE_VERSION:?UPRAVA_TOOLHIVE_VERSION is required}"
