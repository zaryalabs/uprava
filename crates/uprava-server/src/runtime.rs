...
use uprava_protocol::{
    ...
    JobSummary, McpAccessToken, McpDependencyActualState, Message, MessageId, MessageRole,
    ...
    ProjectId, ProjectPlacementId, ProjectPlacementSummary, ProviderMcpAccess,
    ProviderMcpAccessRequest, ProviderQuotaState, ProviderQuotaStatus, ReferenceResolution,
