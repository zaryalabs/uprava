...
use uprava_protocol::{
    ...
    DeductionProviderResult, DeductionRecord, DeductionState, EnrollmentId, EnrollmentState,
    EventEnvelope, EventId, EventKind, EventLogPage, EventPayload, EvidenceId,
    GitWorkspaceSnapshot, HealthResponse, InventorySnapshot, JobDetail, JobId, JobOverlapPolicy,
    JobRunId, JobRunState, JobRunSummary, JobRunTrigger, JobSchedule, JobSummary, McpAccessToken,
    McpDependencyActualState, Message, MessageId, MessageRole, NodeCredentialRotationResponse,
    ...
    ProjectPlacementId, ProjectPlacementSummary, ProviderMcpAccess, ProviderMcpAccessRequest,
    ProviderQuotaState, ProviderQuotaStatus, ReferenceResolution, ReferenceResolutionStatus,
    ResolveApprovalRequest, ResolveReferenceRequest, ResourceBadge, RunJobRequest,
    RuntimeSessionId, RuntimeSessionState, RuntimeSummary, ScheduledMessageFailure,
