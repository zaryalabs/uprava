...
use uprava_protocol::{
    ...
    JobSummary, McpAccessToken, Message, MessageId, MessageRole, NodeCredentialRotationResponse,
    ...
    WebAuthStatusResponse, WorkspaceCheckRunSummary, WorkspaceCommandHistoryItem,
    WorkspaceCommandHistoryResponse, WorkspaceCommandIntent, WorkspaceCommandRunRequest,
    WorkspaceCommandRunResponse, WorkspaceDiffRequest, WorkspaceDiffResponse,
    WorkspaceFileContentResponse, WorkspaceFileWriteRequest, WorkspaceFileWriteResponse,
    WorkspaceReviewProjection, WorkspaceSnapshot, WorkspaceTerminalClientFrame,
