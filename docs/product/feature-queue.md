...
Current release baseline: `0.2.15`. Закрытые пункты `0` through `12`, unified
...
для ручного Linear acceptance — `0.2.14`, production delivery и rollback
контракт этой topology — `0.2.15`.
