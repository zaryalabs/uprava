...
Core/Web/Generated UI Builder/Node/Codex task image refs и checksum извлечённого Node
binary. Manifest не
...
- `deploy` создаёт directories и ops files, устанавливает systemd unit и
  ...
  Core/Web/Generated UI Builder/OpenSandbox и перезапускает Node. Он не проверяет health,
