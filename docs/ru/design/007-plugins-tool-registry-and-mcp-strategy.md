...
Stage 1 should not become an integration platform before the developer
workbench works. Minimal obligations:

- keep Tool Registry and Plugin Registry schemas compatible with future tools;
...
Stage 2 should make modularity real:
