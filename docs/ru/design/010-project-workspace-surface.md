...
Stage 1 должен иметь не полноценную IDE, а **inspect-first, edit-light project
workspace surface**.
...
Stage 1 должен поддерживать базовое редактирование, но в узком контракте.
...
Open question: Stage 1 должен сохранять whole file, применять patch, or support
...
Важная развилка: полноценный interactive PTY или command runner. Для Stage 1
...
- Should Stage 1 save whole file, apply patches, or support both?
...
- When does full IDE sidecar appear: Stage 1 experiment, Stage 2 integration, or
  later?
