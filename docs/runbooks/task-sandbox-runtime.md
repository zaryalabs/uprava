...
Runbook относится к implementation baseline `0.2.22`. Он проверяет
...
Соберите `uprava/codex-runtime:0.2.22` и поднимите pinned OpenSandbox:
...
export UPRAVA_TASK_RUNTIME_IMAGE=uprava/codex-runtime:0.2.22
make node-r
```
