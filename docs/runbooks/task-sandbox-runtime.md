...
Runbook относится к implementation baseline `0.2.21`. Он проверяет
...
Соберите `uprava/codex-runtime:0.2.21` и поднимите pinned OpenSandbox:
...
export UPRAVA_TASK_RUNTIME_IMAGE=uprava/codex-runtime:0.2.21
make node-r
```
