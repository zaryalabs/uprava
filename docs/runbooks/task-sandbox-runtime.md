...
Runbook относится к implementation baseline `0.2.20`. Он проверяет
...
Соберите `uprava/codex-runtime:0.2.20` и поднимите pinned OpenSandbox:
...
export UPRAVA_TASK_RUNTIME_IMAGE=uprava/codex-runtime:0.2.20
make node-r
```
